...
The service worker initialization code is disabled by default. To enable it, uncomment the following code in `smpp-simulator/app/app.module.ts`:
...
Edit [smpp-simulator/app/app.module.ts](smpp-simulator/app/app.module.ts) file:

```
import 'leaflet/dist/leaflet.js';
```

Edit [smpp-simulator/content/scss/vendor.scss](smpp-simulator/content/scss/vendor.scss) file:
...
```
create smpp-simulator/app/my-component/my-component.component.html
create smpp-simulator/app/my-component/my-component.component.ts
update smpp-simulator/app/app.module.ts
```
...
To build the final jar and optimize the smpptools application for production, run:
