...
export class SmscInstanceUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    systemID: [null, [Validators.required, Validators.maxLength(20)]],
    description: [],
    port: [],
    isPersist: [],
    allowAnonymous: [],
  ...
  protected updateForm(smscInstance: ISmscInstance): void {
    this.editForm.patchValue({
      ...
      systemID: smscInstance.systemID,
      isPersist: smscInstance.isPersist,
      allowAnonymous: smscInstance.allowAnonymous,
  ...
  protected createFromForm(): ISmscInstance {
    return {
      ...
      allowAnonymous: this.editForm.get(['allowAnonymous'])!.value,
